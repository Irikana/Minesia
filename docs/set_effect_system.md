...
2. **属性累加**：多个规则的生命值加成会累加，然后转换为生命提升效果等级
...
- 装备状态变化：`[SetEffectMain] 玩家X 装备状态变化`
- 物品规则应用：`[SetEffectMain] 玩家X 应用物品规则 物品ID`
