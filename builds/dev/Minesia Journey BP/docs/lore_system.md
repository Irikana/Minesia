...
| `hasLore` | function | 否 | 判断物品是否已有该 Lore |
...
LoreRegistry.register("my_custom_lore", {
    ...
    canHandle(itemStack, context) {
        return itemStack.typeId.startsWith("minesia_journey:");
    },
...
const SET_EQUIPMENT = {
    "minesia_journey:steel_helmet": { set: "steel", slot: "head" },
    "minesia_journey:steel_chestplate": { set: "steel", slot: "chest" },
    "minesia_journey:steel_leggings": { set: "steel", slot: "legs" },
    "minesia_journey:steel_boots": { set: "steel", slot: "feet" },
    "minesia_journey:dragon_helmet": { set: "dragon", slot: "head" },
    // ... 更多套装装备
};
