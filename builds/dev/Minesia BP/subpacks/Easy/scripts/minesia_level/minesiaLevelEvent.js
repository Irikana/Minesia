...
export class MinesiaLevelEventSystem {
    ...
    static LEVEL_REWARDS = {
        1: { woodCoin: 63, message: "minesia.level.event.level1" },
        2: { woodCoin: 75, message: "minesia.level.event.level2" },
        3: { woodCoin: 100, stoneCoin: 13, message: "minesia.level.event.level3" },
        4: { woodCoin: 125, stoneCoin: 25, message: "minesia.level.event.level4" },
        5: { stoneCoin: 38, toySword: 1, message: "minesia.level.event.level5" },
        6: { stoneCoin: 50, silverCoin: 6, message: "minesia.level.event.level6" },
        7: { stoneCoin: 63, silverCoin: 13, message: "minesia.level.event.level7" },
        8: { silverCoin: 25, message: "minesia.level.event.level8" },
        9: { silverCoin: 31, message: "minesia.level.event.level9" },
        10: { silverCoin: 38, goldCoin: 6, message: "minesia.level.event.level10" },
        11: { silverCoin: 44, goldCoin: 10, message: "minesia.level.event.level11" },
        12: { silverCoin: 50, goldCoin: 13, message: "minesia.level.event.level12" },
        13: { goldCoin: 19, message: "minesia.level.event.level13" },
        14: { goldCoin: 25, message: "minesia.level.event.level14" },
        15: { goldCoin: 31, diamondCoin: 4, message: "minesia.level.event.level15" },
        16: { goldCoin: 38, diamondCoin: 6, message: "minesia.level.event.level16" },
        17: { goldCoin: 44, diamondCoin: 8, message: "minesia.level.event.level17" },
        18: { diamondCoin: 10, message: "minesia.level.event.level18" },
        19: { diamondCoin: 13, message: "minesia.level.event.level19" },
        20: { diamondCoin: 15, emeraldCoin: 1, message: "minesia.level.event.level20" },
        21: { diamondCoin: 19, emeraldCoin: 3, message: "minesia.level.event.level21" },
        22: { diamondCoin: 23, emeraldCoin: 3, message: "minesia.level.event.level22" },
        23: { diamondCoin: 25, emeraldCoin: 4, message: "minesia.level.event.level23" },
        24: { diamondCoin: 28, emeraldCoin: 4, message: "minesia.level.event.level24" },
        25: { diamondCoin: 31, emeraldCoin: 6, message: "minesia.level.event.level25" },
        26: { diamondCoin: 35, emeraldCoin: 8, message: "minesia.level.event.level26" },
        27: { diamondCoin: 38, emeraldCoin: 9, message: "minesia.level.event.level27" },
        28: { diamondCoin: 40, emeraldCoin: 10, message: "minesia.level.event.level28" },
        29: { diamondCoin: 44, emeraldCoin: 11, message: "minesia.level.event.level29" },
        30: { diamondCoin: 50, emeraldCoin: 15, message: "minesia.level.event.level30" },
        31: { diamondCoin: 53, emeraldCoin: 18, message: "minesia.level.event.level31" },
        32: { diamondCoin: 56, emeraldCoin: 20, message: "minesia.level.event.level32" },
        33: { emeraldCoin: 25, message: "minesia.level.event.level33" },
        34: { emeraldCoin: 28, message: "minesia.level.event.level34" },
        35: { emeraldCoin: 31, message: "minesia.level.event.level35" },
        36: { emeraldCoin: 35, message: "minesia.level.event.level36" },
        37: { emeraldCoin: 38, message: "minesia.level.event.level37" },
        38: { emeraldCoin: 40, message: "minesia.level.event.level38" },
        39: { emeraldCoin: 44, message: "minesia.level.event.level39" },
        40: { emeraldCoin: 50, message: "minesia.level.event.level40" },
        41: { emeraldCoin: 56, message: "minesia.level.event.level41" },
        42: { emeraldCoin: 63, message: "minesia.level.event.level42" },
        43: { emeraldCoin: 69, message: "minesia.level.event.level43" },
        44: { emeraldCoin: 75, message: "minesia.level.event.level44" },
        45: { emeraldCoin: 88, message: "minesia.level.event.level45" },
        46: { emeraldCoin: 100, message: "minesia.level.event.level46" },
        47: { emeraldCoin: 113, message: "minesia.level.event.level47" },
        48: { emeraldCoin: 125, message: "minesia.level.event.level48" },
        49: { emeraldCoin: 150, message: "minesia.level.event.level49" },
        50: { emeraldCoin: 188, message: "minesia.level.event.level50" }
    };
    ...
    static playLevelUpSound(player) {
        try {
            ...
            } catch (e2) { console.warn('[Minesia] 备份音效也失败:', e2?.message ?? e2); }
        }
    }
    ...
    static giveItem(player, itemId, count) {
        try { player.runCommand(`give @s ${itemId} ${count}`); } catch (error) { console.warn('[Minesia] 给予物品时出错:', error?.message ?? error); }
    }
}
